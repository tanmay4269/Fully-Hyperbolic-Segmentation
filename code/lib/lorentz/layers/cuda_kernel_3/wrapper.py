...
import lib.lorentz.layers.cuda_kernel_3.optimized_lorentz_conv2d as optimized_lorentz_conv2d
...
class FusedLorentzConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        space_output = optimized_lorentz_conv2d.optimized_lorentz_conv2d_cuda(
            x.contiguous(),
            self.weight,
            bias,
            self.kernel_size,
